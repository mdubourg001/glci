...
module.exports = async (job) => {
  ...
  return {
    ...
    CI_PROJECT_ID: 42,
    CI_PROJECT_NAME: "local-ci-name-stub",
    CI_PROJECT_NAMESPACE: "local-ci-namespace-stub",
    CI_PROJECT_ROOT_NAMESPACE: "local-ci-root-namespace-stub",
    CI_PROJECT_PATH: "local-ci-namespace-stub/local-ci-name-stub",
    CI_PROJECT_PATH_SLUG: "local-ci-namespace-stub-local-ci-name-stub",
    ...
    GITLAB_CI: true,
    GITLAB_USER_EMAIL: "gitlab@local-ci.com",
    GITLAB_USER_ID: 42,
  };
};
